...
//    $query ="SELECT * from lock_info ORDER BY `Lock_ID` ASC " ;
          ...
          <div class='col-md-12'>
            <div class='card '>
              <div class='card-header'>
                <h4 class='card-title'> Locks' Information</h4>
              </div>
              <div class='card-body'>
                  ...
                  <table class='table tablesorter ' id=''>
                    ...
                    while($row = $result->fetch_assoc()) {
                     echo "<tr>
                        ...
                        <a  href='http://localhost:81/bdm/examples/user.php?lock_id=".$row['Lock_ID']."'>

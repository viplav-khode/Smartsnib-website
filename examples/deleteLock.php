<?php 
    ...
    $query = "SELECT  `Lock_ID`, `Area` FROM `lock_info` WHERE 1" ;
          ...
          <div class='col-md-12'>
            <div class='card'>
              ...
              <div class='card-body'>
                  ...
                  <div class='row'>
                    ...
                    <div class='col-md-3 px-md-1'>
                      <div class='form-group'>
                        ...
                        <input type='text' id='oFName' name='oFName' class='form-control' placeholder='Name'>
                      </div> 
                    </div>
                ...
                <button type='submit' class='btn btn-fill btn-primary'>REMOVE</button>
              </div>
                </form>
              </div>
